...
#' @param prediction_interval Predictions over every 50 years(default) can vary based on user preference as larger prediction_interval will reduce computational run time.
