...
The NI GAM contains a spline in time and a spline in space time. When creating a spline, piecewise polynomials join together at knots to create the model fit. The number of knots for these models can be alter to achieve a more smooth model fit. This is done within the `reslr_mcmc` function.
