...
**Step 1:** Load in the data using the `reslr_load` function: 
```{r, load ,eval = TRUE, message=FALSE,results='hide'}
...
```{r,runsp, eval = TRUE, message=FALSE,results='hide'}
