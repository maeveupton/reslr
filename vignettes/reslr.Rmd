...
knitr::include_graphics("https://raw.githubusercontent.com/maeveupton/reslr/blob/main/docs/articles/vig/plotnigamres-1.png")
```
...
knitr::include_graphics("https://raw.githubusercontent.com/maeveupton/reslr/blob/main/docs/articles/vig/plotnigamresrate-1.png")
```
...
knitr::include_graphics("https://raw.githubusercontent.com/maeveupton/reslr/blob/main/docs/articles/vig/plotnigamregres-1.png")
```
...
```
```{r,plotnigamregresrate_load, eval = TRUE,echo=FALSE, fig.align = 'center',fig.width = 7,fig.height = 5}
knitr::include_graphics("https://raw.githubusercontent.com/maeveupton/reslr/blob/main/docs/articles/vig/plotnigamregresrate-1.png")
```
...
```{r,plotnigamlinres_load, eval = TRUE,echo=FALSE, fig.align = 'center',fig.width = 7,fig.height = 5}
knitr::include_graphics("https://raw.githubusercontent.com/maeveupton/reslr/blob/main/docs/articles/vig/plotnigamlinres-1.png")
```
...
```{r,plotnigamnonlinres_load, eval = TRUE,echo=FALSE, fig.align = 'center',fig.width = 7,fig.height = 5}
knitr::include_graphics("https://raw.githubusercontent.com/maeveupton/reslr/blob/main/docs/articles/vig/plotnigamnonlinres-1.png")
```
...
```{r,plotnigamnonlinresrate_load, eval = TRUE,echo=FALSE, fig.align = 'center',fig.width = 7,fig.height = 5}
knitr::include_graphics("https://raw.githubusercontent.com/maeveupton/reslr/blob/main/docs/articles/vig/plotnigamnonlinresrate-1.png")
```
...
```{r,plotnigamall_load, eval = TRUE,echo=FALSE, fig.align = 'center',fig.width = 7,fig.height = 5}
knitr::include_graphics("https://raw.githubusercontent.com/maeveupton/reslr/blob/main/docs/articles/vig/plotnigamall-1.png")
```
