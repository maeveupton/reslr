...
| Site | Region | Age | Age_err | RSL | RSL_err | Longitude | Latitude | linear_rate | linear_rate_err | data_type_id |
|------| ----| -----| ----| ----|----|----|-----|-----|---|----|---|
|"Leeds Point"| "New Jersey" | 1000 | 8 | 0.5 | 0.01 | 39.5 | - 74.4| 1.69 | 0.03|"ProxyRecord"|
|"Leeds Point"| "New Jersey" | 1050 | 11 | 0.6 | 0.01 | 39.5 | - 74.4| 1.69 | 0.03| "ProxyRecord"|
| ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ...|
| ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ...|
| ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ...|
| "Cedar Island" | "North Carolina" | 1700 | 12 | 0.8 | 0.06 | -76.4 | 35 |  0.74 | 0.01 | "ProxyRecord"|
| ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ...|
| ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ...|
| "KEY WEST" | "USA" | 1970 | 5 | 0.6 | 0.02 | -81.8 | 24.6 | 0.1289976 | 0.03 |"TideGaugeData"|
| ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... |

**Check TG name without spaces**
...
- **Optional** data_type_id is a column to identify the sources of data from "ProxyRecord" or "TideGaugeData". The inclusion of tide gauge data is not a requirement, however, it is possible. The user must ensure that the Age is decadally averaged and the uncertainty associated with the age, i.e. Age_err, is 5 years. The uncertainty associated with RSL_err is the standard deviation of the RSL over the 10 years. In addition, the linear_rate and the linear_rate_err must be provided for each tide gauge site.
...
To select the preferred tide gauge, the following criteria is used:**Going to get the user decide these**
