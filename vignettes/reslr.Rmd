...
```{r,eval = TRUE}
jags_output.ni_spline_t <- reslr::run_mcmc(x =  CedarIslandNC,
...
```{r,eval = TRUE}
jags_output.ni_spline_st <- reslr::run_mcmc(x =  multi_site, model_type = "ni_spline_st")
```
...
```{r,eval = TRUE}
output_dataframes <- parameter_estimate(jags_output = run_mcmc(x =  CedarIslandNC, model_type = "ni_spline_t"))
...
```{r, eval = TRUE}
# Example
final_plots <- plot(jags_output = reslr::run_mcmc(x =  CedarIslandNC, model_type = "ni_spline_t"))
