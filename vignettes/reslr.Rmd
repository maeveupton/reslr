...
```{r,runigp_less_it, echo=FALSE,results='hide',message = FALSE,eval = FALSE}
res_eiv_igp_t <- reslr_mcmc(
  input_data = CedarIslandNC_input,
  model_type = "eiv_igp_t",
  CI = 0.95,
...
url <- "https://raw.githubusercontent.com/maeveupton/reslr/blob/main/reslrvigplots/plotigpres-1.png"
...
url <- "https://raw.githubusercontent.com/maeveupton/reslr/blob/main/reslrvigplots/plotigpresrate-1.png"
knitr::include_graphics(url)
```
...
```{r,runspst_less_it,eval = FALSE,echo=FALSE,results='hide',message=FALSE}
res_ni_spline_st <- reslr_mcmc(
  input_data = multi_site_input,
  model_type = "ni_spline_st",
  CI = 0.95,
...
url <- "https://raw.githubusercontent.com/maeveupton/reslr/blob/main/reslrvigplots/plotspstres-1.png"
knitr::include_graphics(url)
```
The output of this function is a graph of the input data, i.e. Age and RSL and associated uncertainty boxes, and the model fit with 95 \% credible interval. The caption provides the model type used and number of proxy sites and tide gauge sites used and can be removed if necessary with `plot_caption = FALSE`. In order to view the rate of change plot, the following setting should be used:
...
url <- "https://raw.githubusercontent.com/maeveupton/reslr/blob/main/reslrvigplots/plotspstresrate-1.png"
knitr::include_graphics(url)
```
...
knitr::include_graphics("https://raw.githubusercontent.com/maeveupton/reslr/blob/main/reslrvigplots/vig/plotnigamres-1.png")
```
...
```{r,plotnigamresrate_load, eval = TRUE,echo=FALSE, fig.align = 'center',fig.width = 7,fig.height = 5}
knitr::include_graphics("https://raw.githubusercontent.com/maeveupton/reslr/blob/main/docs/reslrvigplots/plotnigamresrate-1.png")
```
...
```{r,plotnigamregres_load, eval = TRUE,echo=FALSE, fig.align = 'center',fig.width = 7,fig.height = 5}
knitr::include_graphics("https://raw.githubusercontent.com/maeveupton/reslr/blob/main/reslrvigplots/vig/plotnigamregres-1.png")
```
...
```
```{r,plotnigamregresrate_load, eval = TRUE,echo=FALSE, fig.align = 'center'}
knitr::include_graphics("https://raw.githubusercontent.com/maeveupton/reslr/blob/main/reslrvigplots/vig/plotnigamregresrate-1.png")
```
...
url <- "https://raw.githubusercontent.com/maeveupton/reslr/blob/main/reslrvigplots/plotnigamlinres-1.png"
knitr::include_graphics(url)
```
...
url <- "https://raw.githubusercontent.com/maeveupton/reslr/blob/main/reslrvigplots/plotnigamnonlinres-1.png"
knitr::include_graphics(url)
```
...
url <- "https://raw.githubusercontent.com/maeveupton/reslr/blob/main/reslrvigplots/plotnigamnonlinresrate-1.png"
knitr::include_graphics(url)
```
...
url <- "https://raw.githubusercontent.com/maeveupton/reslr/blob/main/reslrvigplots/plotnigamall-1.png"
knitr::include_graphics(url)
```
