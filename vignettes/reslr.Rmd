...
```{r,runigp_less_it, echo=FALSE,results='hide',message = FALSE,eval = TRUE}
res_eiv_igp_t <- reslr_mcmc(
  input_data = CedarIslandNC_input,
  model_type = "eiv_igp_t",
  CI = 0.95,
...
```{r,runigp_save, echo=FALSE,results='hide',message = FALSE,eval = TRUE}
#res_eiv_igp_t_file <- system.file("reslrVigoutput", "res_eiv_igp_t.rds", package = "reslr")
#res_eiv_igp_t <- readRDS(res_eiv_igp_t_file)
```
...
```{r,runspst_less_it,eval = TRUE,echo=FALSE,results='hide',message=FALSE}
res_ni_spline_st <- reslr_mcmc(
  input_data = multi_site_input,
  model_type = "ni_spline_st",
  CI = 0.95,
...
```{r,plotspstresrate, fig.align = 'center',fig.width = 7,fig.height = 5,eval =TRUE,results='hide',message=FALSE}
plot(res_ni_spline_st,
  plot_type = "rate_plot",
  xlab = "Year (CE)",
  y_rate_lab = "Rate of Change (mm per year)"
...
```{r,plotnigamres_load, eval = TRUE,echo=FALSE, fig.align = 'center',fig.width = 7,fig.height = 5}
knitr::include_graphics("vignettes/vig/plotnigamres.png")
```
...
knitr::include_graphics("vignettes/vig/plotnigamresrate.png")
```
...
knitr::include_graphics("vignettes/vig/plotnigamregres.png")
```
...
knitr::include_graphics("vignettes/vig/plotnigamregresrate.png")
```
...
knitr::include_graphics("vignettes/vig/plotnigamlinres.png")
```
...
knitr::include_graphics("vignettes/vig/plotnigamnonlinres.png")
```
...
knitr::include_graphics("vignettes/vig/plotnigamnonlinresrate.png")
```
...
knitr::include_graphics("vignettes/vig/plotnigamall.png")
```
